  ...
  return (
    <>
      <MiniDrawer user={user || ''} history={history} setMessage={setMessage} setIdConver={setIdConver} nameUser={nameUser}>
        <div className='h-[calc(100svh-4rem)] md:h-[calc(100svh-4rem)] w-full flex flex-col'>
          ...
          <div className='p-2 bg-white border-t border-gray-200'>
            ...
            <div className='flex justify-center w-full'>
              <h2 className='text-[9px] md:text-lg text-gray-500 ml-1'> El asistente puede cometer errores. Considera verificar la información importante </h2>
            </div>
          </div>
        </div>
